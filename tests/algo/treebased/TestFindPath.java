...
public class TestFindPath {
    ...
    public void testFindPath() {
        ...
        List<BinaryTree.Node> path = FindPathRootToNode.findPath(n1, getNode(60));
        assertTrue(path.get(0).data == 30);
        assertTrue(path.get(1).data == 10);
        assertTrue(path.get(2).data == 60);

        // path should be 30->20->35
        path = FindPathRootToNode.findPath(n1, getNode(35));
        assertTrue(path.get(0).data == 30);
        assertTrue(path.get(1).data == 20);
        assertTrue(path.get(2).data == 35);

        // path should be 30->20->45
        path = FindPathRootToNode.findPath(n1, getNode(45));
        assertTrue(path.get(0).data == 30);
        assertTrue(path.get(1).data == 20);
        assertTrue(path.get(2).data == 45);

        // path should be 30->20
        path = FindPathRootToNode.findPath(n1, getNode(20));
        assertTrue(path.get(0).data == 30);
        assertTrue(path.get(1).data == 20);

        // path should be 30
        path = FindPathRootToNode.findPath(n1, getNode(30));
        assertTrue(path.get(0).data == 30);
    }
